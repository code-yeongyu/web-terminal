...
- **States**:
  ...
  - Paste is never disabled: when the Clipboard API is unavailable or blocked, it keeps the terminal focused and shows system-paste guidance so the native Paste key stays one tap away.
